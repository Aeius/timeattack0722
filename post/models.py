...
class JobPostRecruitmentStatus(models.Model):
...
class JobPostActivity(models.Model):
    ...
    status = models.ForeignKey(JobPostStatus, on_delete=models.CASCADE, null=True)
    recruitment_status = models.ForeignKey(JobPostRecruitmentStatus, on_delete=models.CASCADE, null=True)
